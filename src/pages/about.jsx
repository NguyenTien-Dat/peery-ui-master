...
export default function About() {
	return (
		<PageLayout>
			...
			<p className="mt-5">This platform is a product of Group 10, for our capstone project subject SEP490.</p>
			<p>Three months have been spent to build all these from the ground up.</p>

			<div className="flex flex-col gap-4 mt-10">
				<h1 className="text-4xl tracking-tight font-bold">Privacy policy</h1>
				<p className="italic">Last updated: December 12, 2023</p>
				...
				<ul>
					...
					<li>
						<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Peery.</p>
					</li>
					<li>
					...
					<li>
						<p><strong>Website</strong> refers to Peery, accessible from <a href="https://ganans.online" rel="external nofollow noopener" target="_blank">https://ganans.online</a></p>
					</li>
					<li>
				...
				<ul>
					<li>
						<p>By email: <Link href="mailto:c93516301@gmail.com">c93516301@gmail.com</Link></p>
					</li>
					<li>
						<p>By visiting this page on our website: <Link href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" rel="external nofollow noopener" target="_blank">https://www.youtube.com/watch?v=dQw4w9WgXcQ</Link></p>
					</li>
					<li>
						<p>By mail: FPT University, Hoa Lac Hi-Tech Park, Thach That District, Ha Tay Province, Vietnam</p>
					</li>
				</ul>
			</div>
		</PageLayout>
